    ...
    <>
      <div className="grid grid-cols-12 gap-[30px]">
        {profilecards.map((item, i) => (
          <div className="lg:col-span-4 md:col-span-6 col-span-12" key={i}>
            <CardBox>
              <div className="flex items-center">
                ...
                <div className="ms-3">
                  ...
                  <p className="text-xs text-darklink flex gap-1 items-center"><IconMapPin size={15}/> {item.subtitle}</p>
                </div>
