      ...
      <CardBox className="mt-[30px] p-0 overflow-hidden">
        <div className="p-6">
          <div className="flex justify-between items-center ">
            ...
            <div className="h-10 w-10 bg-lightprimary dark:bg-darkprimary rounded-md flex justify-center items-center">
              <Image src={icon} alt="icon" />
            </div>
          </div>
          <div className="flex items-center mb-3 mt-1 gap-2">
            <h4 className="text-2xl">$6,820</h4>
            <span className="rounded-full p-1 bg-lightsuccess dark:bg-darksuccess text-success flex items-center justify-center ">
