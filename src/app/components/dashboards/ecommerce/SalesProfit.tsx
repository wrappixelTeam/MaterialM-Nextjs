          ...
          >
            <li role="presentation">
              <button
                ...
                data-tabs-target="#styled-profit"
                type="button"
                role="tab"
            ...
            <li role="presentation">
              <button
                ...
                data-tabs-target="#styled-expenses"
                type="button"
                role="tab"
      ...
      <div id="default-styled-tab-content">
        ...
        >
          ...
          <div className="flex justify-between items-center mt-6">
              ...
              <div className="flex gap-2 items-center">
                ...
                <div>
                  <h6 className="text-base">
                    $63,489.50{" "}
                    <span className="bg-lightsuccess dark:bg-darkprimary rounded-full text-success text-xs py-[5px] px-[10px]">
                      +8%
                    </span>
                  </h6>
            ...
            <div>
              <Link href={""} className="btn py-3 px-12 ">
                View Details
              </Link>
            </div>
          </div>
