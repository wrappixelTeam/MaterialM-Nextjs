    ...
    <>
      <CardBox>
        ...
        <Chart
          ...
          className="mt-5"
        />
        <div className="bg-lightsuccess dark:bg-darksuccess mx-auto -mt-4 text-success flex gap-1 items-center py-2 px-3 rounded-full w-fit justify-center text-xs font-medium">
          ...
          {chartData.map((item, index) => (
            <div className="sm:col-span-6  col-span-12 " key={index}>
              <div className="flex gap-2 items-center">
                ...
                ></span>
                <p className="text-sm text-dark dark:text-white">{item.title}</p>
              </div>
            </div>
          ))}
        </div>
