  ...
  return (
    <>
      <CardBox className="pb-2">
        ...
        <div className="grid grid-cols-12 mt-2 gap-[30px]">
          ...
          <Table.Head>
            ...
            <Table.HeadCell className="text-base font-semibold pb-2 text-end text-primary dark:text-primary pe-0">
              <span className="flex items-center justify-end text-sm">
                See All <IconChevronRight className="ms-1" size={15} />
              </span>
            </Table.HeadCell>
          </Table.Head>
            ...
            {TransactionsData.map((item, index) => (
              <Table.Row key={index}>
                ...
                <Table.Cell className="text-end pe-0">
                  ...
                  <p className={`text-xs font-medium text-${item.rankcolor}`}>{item.rank}</p>
                </Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
