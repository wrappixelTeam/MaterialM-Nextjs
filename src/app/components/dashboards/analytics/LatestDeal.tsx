    ...
    <>
      <CardBox>
        ...
        <div className="flex">
          ...
          <div className="-ms-2 ">
            <div className="bg-lightsecondary border-2 border-white dark:border-darkborder  h-10 w-10 flex justify-center items-center text-secondary rounded-full dark:bg-darksecondary">
              +8
            </div>
          </div>
        </div>
